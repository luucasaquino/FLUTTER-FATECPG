              ...
              children: <Widget>[
                TextField(
                  ...
                  decoration: InputDecoration(
                      labelText: "Título", hintText: "Digite o nome..."),
                ),
                TextField(
                  controller: _descricaoController,
                  decoration: InputDecoration(
                      labelText: "Descrição", hintText: "Digite o número..."),
                )
              ],
            ),
            actions: <Widget>[
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      child: ListTile(
                        ...
                        subtitle: Text("Número: ${tarefa.description}"),
                        trailing: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: <Widget>[
                            GestureDetector(
      ...
      floatingActionButton: RaisedButton(
        ...
        color: Colors.black,
        child:
            Text("NOVO", style: TextStyle(color: Colors.white, fontSize: 20.0)),
      ),
    );
  }
}
